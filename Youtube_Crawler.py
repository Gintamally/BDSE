...
# C:\Users\Lee\Anaconda3\python.exe "$(FULL_CURRENT_PATH)"
...
BathDownloadThread(lst[0:125],'Violin').start()
BathDownloadThread(lst[125:250],'Violin').start()
BathDownloadThread(lst[250:375],'Vionlin').start()
BathDownloadThread(lst[375:500],'Vionlin').start()